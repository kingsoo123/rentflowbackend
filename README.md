...
- `POST /api/auth/signup` — register with JSON body `{ name, role, email, password, confirmPassword, terms }` (`role`: `property_manager` | `tenant`, same as the EstateFlow signup form)
